            ...
            {userRole === "seller" && (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    handleFilterChange("sellerOnly", e.target.checked)
                  }
                  id="seller-only"
                />
                <label htmlFor="seller-only" style={{ fontSize: "14px" }}>
                  My Products Only
                </label>
              </div>
            )}
        ...
        {products.map((product) => (
          <div key={product.product_id} className="product-card">
            ...
            {product.inventories &&
              ...
              product.inventories[0].discount > 0 && (
                    ...
                    <div className="metric-item">
                      ...
                      <div className="metric-value">
                        ...
                        product.inventories[0].discount > 0
                          ? (
                              product.price *
                              (1 - product.inventories[0].discount / 100)
                            ).toFixed(2)
                          : product.price}
                        /unit
                      </div>
