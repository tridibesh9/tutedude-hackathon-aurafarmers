...
const ProductForm = () => {
  ...
  const handleInventoryChange = (field, value, discountType = null) => {
    setInventoryData((prev) => {
      if (discountType) {
        // Handle discount object updates
        return {
          ...prev,
          discount: {
            ...prev.discount,
      ...
      if (isEdit) {
        ...
        if (inventoryData.quantity) {
          await inventoryAPI.addInventory(
            ...
            {
              solo_singletime: parseFloat(
                inventoryData.discount.solo_singletime || 0
              ),
              subscription: parseFloat(
                inventoryData.discount.subscription || 0
              ),
              group: parseFloat(inventoryData.discount.group || 0),
            },
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                >
                  Single Purchase Discount
                </label>
                <input
                  type="number"
                  value={inventoryData.discount.solo_singletime}
                  onChange={(e) =>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <input
                  type="number"
                  value={inventoryData.discount.subscription}
                  onChange={(e) =>
                    handleInventoryChange(
                      "discount",
                      e.target.value,
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <input
                  type="number"
                  value={inventoryData.discount.group}
                  onChange={(e) =>
                    handleInventoryChange("discount", e.target.value, "group")
                  }
                  min="0"
                  max="100"
                  step="0.1"
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInventoryChange("expiry_date", e.target.value)
                }
                style={{
                  width: "100%",
                  padding: "8px 12px",
